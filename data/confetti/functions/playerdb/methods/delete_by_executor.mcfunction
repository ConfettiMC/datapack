...
execute if score #Passed confetti matches 0 run data modify storage confetti PlayerDB prepend from storage confetti Stack[-1]
scoreboard players remove #i api 1
data remove storage confetti Stack[-1]
execute if score #i api matches 1.. run function confetti:playerdb/methods/delete_by_executor
